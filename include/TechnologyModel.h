...
public:
    ...
    TechnologyModel& operator=(const TechnologyModel& other) = delete;

    TechnologyModel& operator=(TechnologyModel&& other) noexcept = delete;

    enum TechnologyRole
    {
        TechnologyRoleName = Qt::DisplayRole,
     ...
     */
    explicit TechnologyModel(QObject* parent = nullptr) noexcept;

    /** Destructor. */
    ~TechnologyModel() override = default;
